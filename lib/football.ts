...
export type Country = {
  ...
  c1: string;
  c2: string;
  square?: string; // small accent square between the "2" and "6"
};
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Chile", code: "CHI", flag: "🇨🇱", c1: "#0039A6", c2: "#D52B1E", square: "#ffffff" },
  { name: "Colombia", code: "COL", flag: "🇨🇴", c1: "#FCD116", c2: "#003893" },
  { name: "Croatia", code: "CRO", flag: "🇭🇷", c1: "#FF0000", c2: "#171796", square: "#ffffff" },
  ...
  { name: "England", code: "ENG", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", c1: "#CE1124", c2: "#0A2472", square: "#ffffff" },
  { name: "France", code: "FRA", flag: "🇫🇷", c1: "#0055A4", c2: "#EF4135", square: "#ffffff" },
  ...
  { name: "Netherlands", code: "NED", flag: "🇳🇱", c1: "#AE1C28", c2: "#21468B", square: "#ffffff" },
  { name: "Nigeria", code: "NGA", flag: "🇳🇬", c1: "#008751", c2: "#ffffff" },
  { name: "Norway", code: "NOR", flag: "🇳🇴", c1: "#EF2B2D", c2: "#002868", square: "#ffffff" },
  ...
  { name: "Serbia", code: "SRB", flag: "🇷🇸", c1: "#C6363C", c2: "#0C4076", square: "#ffffff" },
  ...
  { name: "United States", code: "USA", flag: "🇺🇸", c1: "#B31942", c2: "#0A3161", square: "#ffffff" },
